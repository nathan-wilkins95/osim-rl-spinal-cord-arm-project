...
print(args.visualize, type(args.visualize))
...
if args.train:
    ...
    file_pickle = '/home/reluctanthero/Code/osim-rl(1)/examples/figures/MS_figures/d_combined_states.pkl'
    ...
    save_plots = True
    path_fig_base = '/home/reluctanthero/Code/osim-rl(1)/examples/figures/MS_figures'
    ...
    plt.ylabel('rew [-]')
    if save_plots:
        file_name_fig = f'MS_model_rew.png'
    ...
    plt.ylabel('y [m]')
    if save_plots:
        file_name_fig = f'MS_model_obs.png'
        file_fig = path_fig + '/' + file_name_fig
        plt.savefig(file_fig)
        plt.close()
    else:
    ...
    for key, item in d_states.items():
        ...
        if save_plots:
            file_name_fig = f'MS_model{key}.png'
            file_fig = path_fig + '/' + file_name_fig
            plt.savefig(file_fig)
            plt.close()
        else:
